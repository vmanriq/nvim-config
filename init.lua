...
require('lazy').setup({
        ...
        dependencies = {
          {
            ...
            config = function()
              ...
              -- Load custom Lua-defined snippets from lua/custom/snippets/
  ...
  { -- Collection of various small independent plugins/modules
    ...
    config = function()
      ...
      -- Show error/warning counts in statusline
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = {
        ...
        'typescript', 'tsx', 'javascript', 'json', 'jsonc', 'yaml', 'toml', 'css', 'python',
      },
...
-- AWS SSO helper (:AwsCheck / :AwsLogin) — module casero, no es plugin
require('custom.aws').setup()
